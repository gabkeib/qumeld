...
reg_config = [
    [4, 7, 12, -0.4896551724137931, 0.7409909909909911],
    [4, 8, 12, -0.6, 1.0500000000000003],
    [4, 9, 12, -0.6, 0.7725225225225225],
    [4, 10, 12, -0.593103448275862, -2.3554054054054054],
]
er_config = [
    [7, 0.5, 12, -1.5908026755852842, -0.600501672240803],
    [8, 0.5, 12, -1.6750836120401338, 0.8322742474916387],
    [9, 0.5, 12, 1.6329431438127089, 1.6118729096989965],
    [10, 0.5, 12, 0.49515050167224084, 3.0657190635451506],
]
n = len(reg_config)
import time
