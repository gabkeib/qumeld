    ...
    for i in ps_layers:
        for j in i:
            for k in j:
                ...
                qc.cx(
                    pauli_map[ns[0]], pauli_map[ns[1]]
                )  # I only output the logical embedding in the physical device, I will not handle connectivity
