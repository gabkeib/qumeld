...
def PH_Mahattan(parr):
    ...
    length = (
        lnq // 2
    )  # `length' is a hyperparameter, and can be adjusted for best performance. Here we keep `length' fixed for simplicity.
    ...
    print(
        f"CNOT: {ansatz.n_gates_of_type(OpType.CX)}, Single: {ansatz.n_gates - ansatz.n_gates_of_type(OpType.CX)}, Total: {ansatz.n_gates}, Depth: {ansatz.depth()}"
    )
...
def TK_Mahattan(parr):
    ...
    qc = transpile(
        qc,
        basis_gates=["cx", "u3"],
        coupling_map=mahattan_coupling,
...
ising_parr = [
    gene_dot_1d(29),
    gene_dot_2d(4, 5, interaction="Z"),
    gene_dot_3d(1, 2, 4, interaction="Z"),
]
heisen_parr = [
    gene_dot_1d(29, interaction="Z")
    + gene_dot_1d(29, interaction="X")
    + gene_dot_1d(29, interaction="Y"),
    gene_dot_2d(4, 5, interaction="Z")
    + gene_dot_2d(4, 5, interaction="Y")
    + gene_dot_2d(4, 5, interaction="X"),
    gene_dot_3d(1, 2, 4, interaction="Z")
    + gene_dot_3d(1, 2, 4, interaction="Y")
    + gene_dot_3d(1, 2, 4, interaction="X"),
]
