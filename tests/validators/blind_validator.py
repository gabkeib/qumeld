...
class BlindValidator:
    ...
    def _remap_counts(
        self, counts_map: Dict[str, int], layout_map: Dict[int, int], n_orig: int
    ) -> Dict[str, int]:
        """
    ...
    def validate(
        self, original: QuantumCircuit, mapped: QuantumCircuit
        ...
        layout = self._infer_layout(
            counts_orig, original.num_qubits, counts_map, mapped.num_qubits
        )
