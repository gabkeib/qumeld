...
def get_test_circuits() -> list[QuantumCircuit]:
    ...
    # 1. Bell pair (simplest entanglement)
    ...
    # 3. Linear chain (minimal SWAPs on linear topology)
    ...
    qc.h(range(5))
    for i in range(1, 5):
        qc.cx(0, i)  # Central qubit connected to all
    circuits.append(qc)
    
    # 6. Fully connected (stress test)
    ...
    # 7-9. Random circuits with controlled seed
